...
public class TestApp {
	...
	public static void main(String[] args) {
		...
		if (args.length != 4) {
			...
			System.out
					.println("program <app id> <password> <input file> <output file>");
			return;
		}
		...
		try {
			...
			if (outputFile.endsWith("xml")) {
				...
				if (outputFile.endsWith("pdf")) {
					System.out
							.println("Image will be converted to searchable pdf");
					...
					System.out
							.println("Seems that the output format is unknown. " +
									"Trying to convert the image to searchable pdf.");
				}
				System.out
						.println("Recognition with English language. " +
								"If your documents contain other languages, please specify them.");
			...
			if (task.Status == Task.TaskStatus.Completed) {
				...
				System.out
						.println("Not enough credits to process document. " +
