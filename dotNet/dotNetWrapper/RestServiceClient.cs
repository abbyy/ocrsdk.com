...
namespace Abbyy.CloudOcrSdk
{
    ...
    public class RestServiceClient
    {
        ...
        public OcrTask ProcessImage(string filePath, ProcessingSettings settings)
        {
            ...
            try
            {
                ...
                OcrTask task = ServerXml.GetTaskStatus(response);
        ...
        public OcrTask UploadAndAddFileToTask(string filePath, TaskId taskToAddFile )
        {
        ...
        public OcrTask StartProcessingTask(TaskId taskId, ProcessingSettings settings)
        {
            ...
            XDocument response = performRequest(request);
            OcrTask serverTask = ServerXml.GetTaskStatus(response);
            return serverTask;
        }
        ...
        public OcrTask ProcessTextField(string filePath, TextFieldProcessingSettings settings)
        {
        ...
        /// </summary>
        /// <returns>Id of created task</returns>
        public OcrTask ProcessBarcodeField(string filePath, BarcodeFieldProcessingSettings settings)
        {
        ...
        public OcrTask ProcessCheckmarkField(string filePath, CheckmarkFieldProcessingSettings settings)
        {
        ...
        public OcrTask ProcessBusinessCard(string filePath, BusCardProcessingSettings settings)
        {
        ...
        public OcrTask ProcessFields(OcrTask task, string settingsPath)
        {
            ...
            XDocument response = performRequest(request);
            OcrTask result = ServerXml.GetTaskStatus(response);
        ...
        /// </summary>
        public OcrTask ProcessMrz(string filePath)
        {
        ...
        public void DownloadResult(OcrTask task, string outputFile)
        {
        ...
        public OcrTask GetTaskStatus(TaskId task)
        {
        ...
        /// </summary>
        public OcrTask[] ListTasks( DateTime changedSince )
        {
            ...
            OcrTask[] tasks = ServerXml.GetAllTasks(response);
            return tasks;
        }
        ...
        /// </summary>
        public OcrTask[] ListFinishedTasks()
        {
        ...
        /// </summary>
        public OcrTask DeleteTask(OcrTask task)
        {
            switch (task.Status)
            {
